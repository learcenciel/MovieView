...
class MovieDetailsViewController: UIViewController {
    ...
    func setupNavigationSection() {
        ...
        self.navigationController?.view.backgroundColor = UIColor.init(red: 130/255,
                                                                       green: 130/255,
                                                                       blue: 130/255,
                                                                       alpha: 1)
    ...
    func setupCollectionView() {
        ...
        let size = Int((movieCastCollectionView.bounds.width - totalSpace) / CGFloat(noOfCellsInRow))
...
extension MovieDetailsViewController: MovieDetailsView {
    ...
    func displayMovieDetails(movieDetailsInfo: MovieDetailInfo) {
        ...
        self.durationLabel.text = movieDetailsInfo.movieRuntime?.durationFormat()
...
extension MovieDetailsViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellId", for: indexPath) as? MovieCastCollectionViewCell
        else { fatalError() }
